              ...
              <div className="flex gap-2 ">
                ...
                >
                  <span className=" text-sm font-bold text-gray-300  whitespace-nowrap ">
                    ...
                    Vitae est eligendi nostrum. Error provident cumque odit
                    consequuntur consectetur ab culpa sunt, quae pariatur illo
                    iure fugit veritatis eum, voluptas porro.
                  </span>
                </label>
              </div>
